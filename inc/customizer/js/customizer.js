(function( $ , api){
    ...
    api.section( 'fitnstr_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'fitnstr_about_section' , function( section ){
    ...
    api.section( 'fitnstr_blog_section' , function( section ){
    ...
    api.section( 'fitnstr_portfolio_section' , function( section ){
    ...
    api.section( 'fitnstr_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-fitnstr_contact_custom_formshortcode'),
                selector = $('#_customize-input-fitnstr_contact_formshortcode');
    ...
    // General section
    api.section( 'fitnstr_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#fitnstr_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-fitnstr_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-fitnstr_preloader_color' );
            ...
            var $backtotop          = $( '#fitnstr_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-fitnstr_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-fitnstr_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'fitnstr_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#fitnstr_footer_widget_toggle');

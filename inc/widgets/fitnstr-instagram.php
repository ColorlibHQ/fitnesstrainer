...
----------------------------------------*/
class fitnstr_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('fitnstr_instagram_photo',esc_html__('[ Fitnstr ] Intagram Photo','fitnstr'),array(
			'description' => esc_html__('Fitnstr Instagram Photo Widget','fitnstr'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'fitnstr');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'fitnstr'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'fitnstr'); ?></label>
...
if(!function_exists('fitnstr_instagram_widgets')):
	function fitnstr_instagram_widgets(){
		register_widget('fitnstr_instagram_photo');
	}
	add_action('widgets_init','fitnstr_instagram_widgets');
endif;

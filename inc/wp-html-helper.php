...
// image default alt
if( !function_exists( 'fitnstr_img_default_alt' ) ){
	function fitnstr_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'fitnstr_img_tag' ) ){
	function fitnstr_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = fitnstr_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'fitnstr_anchor_tag' ) ){
	function fitnstr_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'fitnstr_heading_tag' ) ){
	function fitnstr_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'fitnstr_paragraph_tag' ) ){
	function fitnstr_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'fitnstr_other_tag' ) ){
	function fitnstr_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'fitnstr_button_element ' ) ){
	function fitnstr_button_element( array $args ){
